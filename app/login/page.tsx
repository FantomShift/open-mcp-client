...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="hidden md:flex md:w-1/2 bg-blue-600 flex-col justify-between p-10">
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center p-6">
        <div className="w-full max-w-md">
          ...
          <div className="md:hidden flex items-center justify-center mb-8">
            ...
            <span className="ml-3 text-gray-900 font-semibold text-xl">UIP Admin</span>
          </div>
          ...
          <div className="bg-white p-8 rounded-lg border border-gray-200 shadow-sm">
            ...
            <div className="grid grid-cols-2 gap-3 mb-4">
              <button
                ...
                disabled={loading}
                className="flex items-center justify-center gap-2 p-2 border border-gray-300 rounded-md hover:bg-gray-50 disabled:opacity-70"
              >
            ...
            <form onSubmit={handleAuth} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  required
                  disabled={loading}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-70"
                />
              </div>

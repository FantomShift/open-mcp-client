      ...
      <div className="flex items-center gap-4">
        <div className="relative hidden md:flex">
          ...
          <input
            type="search"
            placeholder="Search..."
            className="h-9 w-[200px] rounded-md border border-gray-300 bg-white pl-8 pr-3 text-sm focus:outline-none focus:ring-2 focus:ring-gray-400 focus:border-gray-400"
          />
        </div>
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <button 
              className="flex items-center gap-2 rounded-full p-1.5 text-sm font-medium text-gray-900 hover:bg-gray-100"
          ...
          <DropdownMenuContent align="end" className="w-56">
            <DropdownMenuLabel>
              <div className="flex flex-col space-y-1">
                ...
                <p className="text-xs text-gray-500">{isLoading ? "Loading..." : user.email}</p>
              </div>
            </DropdownMenuLabel>
            <DropdownMenuSeparator />
